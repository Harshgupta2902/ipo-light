...
//     return {
//       indices: responses[0].data,
//       gainers: responses[1].data,
//       losers: responses[2].data,
//       mostActive: responses[3].data,
//       approachingHigh: responses[4].data,
//       approachingLow: responses[5].data,
//     };
//   } catch (error) {
